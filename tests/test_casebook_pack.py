"""Regression checks for the vector-sys-fd-lens casebook."""
...
from casebook.harness import assert_expected, vector_sys_fd_lens_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(vector_sys_fd_lens_summary(), assert_expected())
